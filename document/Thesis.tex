...
\lstset{
	basicstyle=\ttfamily,  % Estilo de fuente (usa una fuente monoespaciada)
	breaklines=true,        % Permite que las líneas largas se dividan
	extendedchars=true,     % ¡Importante! Permite el uso de caracteres extendidos
	inputencoding=utf8,     % ¡Importante! Especifica la codificación de entrada
	literate={á}{{\'a}}1
	{é}{{\'e}}1
	{í}{{\'i}}1
	{ó}{{\'o}}1
